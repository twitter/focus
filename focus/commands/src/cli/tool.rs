...
impl Tool {
    ...
    pub fn invoke(&self, args: Option<&Vec<OsString>>, dir: Option<&Path>, stdin_file: Option<Stdio>, sandbox: &Sandbox) -> Result<InvocationResult> {
...
mod tests {
    ...
    fn arg_handling() -> Result<()> {
        ...
        let args = vec![OsString::from("-n"), OsString::from("fee"), OsString::from("fie"), OsString::from("foe"), OsString::from("fum")];
